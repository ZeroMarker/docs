...
Gartner 提出的 **Hype Cycle（技术成熟度曲线）** 试图描述这种预期变化。它是一种分析框架，不是自然定律，也不能证明每项技术都会依次经历全部阶段。
...
- [Gartner：Hype Cycle 研究方法](https://www.gartner.com/en/research/methodologies/gartner-hype-cycle)

Hype Cycle 主要追踪市场预期，而不是直接测量性能、采用率或商业价值。判断具体技术时，还应结合可重复的技术基准、用户采用数据、成本与监管环境。
