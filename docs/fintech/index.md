...
> 本页是跨市场概览，不是开户、合规或付款保证。系统覆盖、限额、费用和参与机构变化很快；实际使用前应核对相应央行、系统运营方和开户机构的最新资料。各国详情页应优先引用本地一手来源。
...
| 欧洲部分市场 | [Wero](欧洲-Wero.md) | 手机号、邮箱、二维码、银行 App 或 Wero App | EPI 推出的即时 A2A 钱包；比利时、法国、德国已上线，卢森堡分阶段迁移，荷兰处于 iDEAL/Wero 过渡期 |
